# initial data has three columns: code, monthly date, closing price at the end of the month
# now need to generate monthly return data for the past 24 months for each row (for each stock at each time node)
